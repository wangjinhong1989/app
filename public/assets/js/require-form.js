            ...
            faselect: function (form) {
                ...
                if ($(".fachoose", form).size() > 0) {
                    $(".fachoose", form).on('click', function () {
                        ...
                        parent.Fast.api.open("http://app.xwxyq.cn/ENcrpBsTSt.php/general/attachment/select?element_id=" + $(this).attr("id") + "&multiple=" + multiple + "&mimetype=" + mimetype + "&admin_id=" + admin_id + "&user_id=" + user_id, __('Choose'), {
