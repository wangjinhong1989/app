define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form,bannerList) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'banner_detail/index' + location.search,
                    add_url: 'banner_detail/add',
                    edit_url: 'banner_detail/edit',
                    del_url: 'banner_detail/del',
                    multi_url: 'banner_detail/multi',
                    table: 'banner_detail',
                }
            });
    ...
    function queryParams(pageReqeust) {
        ...
        pageReqeust.filter["bannername.name"]="详情页";
