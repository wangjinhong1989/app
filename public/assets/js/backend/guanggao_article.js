define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'guanggao_article/index' + location.search,
                    add_url: 'guanggao_article/add',
                    edit_url: 'guanggao_article/edit',
                    del_url: 'guanggao_article/del',
                    multi_url: 'guanggao_article/multi',
                    table: 'guanggao_article',
                }
            });
