                        ...
                        click: function (e) {
                            ...
                            if (!match) {
                                ...
                                if (youkuMatch && youkuMatch[1].length) {
                                    ...
                                    var html='<iframe frameborder="0" height="310" width="510" src="http://v.qq.com/iframe/player.html?vid='+ vid+'&amp;auto=0"></iframe>'
                                }else{
                                    var html = '<iframe src="' + url + '" frameborder="0" style="width:' + width + 'px;height:' + height + 'px;"></iframe>';
                                }
