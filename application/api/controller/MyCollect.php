...
class MyCollect extends Api
{
    ...
    public function Lists()
    {
        ...
        $user_id=$user->id;
        $lists=( new Shoucang())->alias("shoucang")->with((new Article())->getTable("article")." article")->where(['shoucang.user_id'=>$user_id,'article.id=shoucang.article_id'])->select("shoucang.*,article.title");
        $this->success($lists);
    }
