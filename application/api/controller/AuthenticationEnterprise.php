 ...
 * 首页接口
 */
class AuthenticationEnterprise extends Api
{
    ...
    public function Lists()
    {
        ...
        $user_id = $user->id;
        $lists=( new \app\admin\model\AuthenticationEnterprise())->where(["user_id"=>$user_id])
            ->find();
    ...
    * **/
    public function add()
    {
        ...
        try{
            $model=new \app\admin\model\AuthenticationEnterprise();
            $user = $this->auth->getUser();
            $user_id = $user->id;
