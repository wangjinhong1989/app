 ...
 * @icon fa fa-circle-o
 */
class Tanchuang extends Backend
{
    
    /**
     * Tanchuang模型对象
     * @var \app\admin\model\Tanchuang
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Tanchuang;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            foreach ($list as $row) {
                $row->visible(['id','title','paixu','image','url_type','url','status']);
                $row->visible(['article']);
