 ...
 * @icon fa fa-circle-o
 */
class ZhengjianMeiti extends Backend
{
    
    /**
     * ZhengjianMeiti模型对象
     * @var \app\admin\model\ZhengjianMeiti
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\ZhengjianMeiti;
        $this->view->assign("certificatesTypeList", $this->model->getCertificatesTypeList());
