<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/www/wwwroot/app/public/../application/admin/view/authentication/add.html";i:1575161551;s:59:"/www/wwwroot/app/application/admin/view/layout/default.html";i:1575082205;s:56:"/www/wwwroot/app/application/admin/view/common/meta.html";i:1575082205;s:58:"/www/wwwroot/app/application/admin/view/common/script.html";i:1575082205;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Certificates_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-certificates_id" data-rule="required" data-source="certificates/index" class="form-control selectpage" name="row[certificates_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
