<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"/www/wwwroot/app/public/../application/admin/view/reply/edit.html";i:1575103400;s:59:"/www/wwwroot/app/application/admin/view/layout/default.html";i:1575082205;s:56:"/www/wwwroot/app/application/admin/view/common/meta.html";i:1575082205;s:58:"/www/wwwroot/app/application/admin/view/common/script.html";i:1575082205;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-parent_id" data-rule="required" data-source="parent/index" class="form-control selectpage" name="row[parent_id]" type="text" value="<?php echo htmlentities($row['parent_id']); ?>">
        </div>
    </div>
    <div class="form-group">
